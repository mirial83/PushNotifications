...
function showDetailStatus(details) {
...
function displayDownloadStats(stats) {
...
function updateUIForCurrentPhase(phase) {
...
function showLaunchingState() {
    // Show launching status
    // Update UI message
    // Show transition state
    // Handle launch feedback
}
...
// Utility Functions
function formatProgressText(percentage) {
